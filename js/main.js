...
import { renderWorkReports, openNewWReport, editWReportById, saveWReport, delWReport, delWReportById, exportWReportPDF, addEquipRow, clearSig, wrToggleGuest, wrUpdateHours } from './workreports.js';
import { renderQuotes, openNewQuote, editQuoteById, saveQuote, delQuote, delQuoteById, exportQuotePDF, addQuoteItemRow, wqRecalc, qToggleGuest, convertQuoteToFault } from './quotes.js';
